...
import { workflowActivities,dispatchOutbox } from '../../../services/worker/src/withdrawal-worker.ts';
import { connectTemporal } from '../../../services/worker/src/probe-client.ts';
import { signCommand,digest } from '../../../shared/contracts/src/crypto.ts';
import { SignedCommand,Workflow,ReceiptView,CONTRACT_VERSION } from '../../../shared/contracts/src/index.ts';
...
try {
 ...
 const agent=start('services/agent/src/main.ts');
 ...
 const replacement=start('services/worker/src/main.ts');
