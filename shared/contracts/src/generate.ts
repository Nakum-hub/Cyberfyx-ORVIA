...
for(const route of routes){
  ...
  const security=route.authority==='PUBLIC'?[]:route.authority==='STAFF_OR_PRINCIPAL'?[{staffSession:[]},{principalSession:[]},{staffSecureSession:[]},{principalSecureSession:[]}]:route.authority==='STAFF'?[{staffSession:[]},{staffSecureSession:[]}]:route.authority==='PRINCIPAL'?[{principalSession:[]},{principalSecureSession:[]}]:[{machineCredential:[]}];
