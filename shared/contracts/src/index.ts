...
export const CONTRACT_VERSION = '0.32.0' as const;
...
export const routes: RouteDefinition[] = [
  ...
  {id:'list_test_runs',method:'get',path:'/api/v1/admin/test-runs',authority:'STAFF',capability:'tests.read',response:'TestRunList',status:200,paginated:true},
