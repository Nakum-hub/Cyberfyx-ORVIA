...
import { CommandReceipt,SignedCommand } from '../../../shared/contracts/src/index.ts';
import { verifyCommand,digest } from '../../../shared/contracts/src/crypto.ts';
import { machineAuthority } from '../../../backend/auth/src/machine.ts';
import type { AgentEnrollmentConfig } from '../../../backend/auth/src/machine-profile.ts';
import { scopedTransaction } from '../../../database/customer/src/runtime.ts';
import { lockConsent,audit } from '../../../backend/domain/src/shared/transaction.ts';
