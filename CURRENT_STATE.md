...
| Work branch / PR | `prototype/work/W00-bootstrap-review`; initial published checkpoint `ebaea86cae793d04808a1fc983e1adc31b1bbe06`; [draft PR #1](https://github.com/Nakum-hub/Cyberfyx-ORVIA/pull/1). Publication metadata follows in the PR; inspected base remains separate |
...
| Next merge | Human reviews [draft PR #1](https://github.com/Nakum-hub/Cyberfyx-ORVIA/pull/1) and decides whether to integrate this Work checkpoint. Reviewed A00 follows. Publication does not accept W00/A00; no merge/release performed |
