...
| Frozen final candidate | **IDENTIFIED.** Source `81431d64afb8dd613c96d942402d8c0d8cc07ac0`; tree `e949d8c43c0dfffcea2e332eb7baa7eb2a052f0524709e6d533dcd566304e437`; manifest `artifacts/release-manifest.json` SHA-256 `95f5acbe94eecc1ef8296779b6ce3c1116c067753fd2e5bd199d6e340d24e026`; host build `mtRrfhGjl22jabwoImHIf`; container build `aMloAQd7rLFKm0GE_Sge1`; runtime image `sha256:48c3b41efb3d5d409dd49f44b422f7c034339af2ecd5ff3915d707b1189d7bf2`; profile `rehearsal`; fixture `aster-birch-v1`; Playwright 1.63.0. Independently verified: **242 checks, 0 failures** (`handoffs/work/final-prototype-continuation/candidate-verification.json`). The historical 0.4.1 candidate `766854399d411c551c4d3f657ea2b4f3f189a4bd` is superseded and must not be described as covering these corrections. |
...
| Canonical acceptance | T01–T34 remain **NOT_RUN**. 25 of the 30 P0 scenarios have every covering component suite passing at this exact candidate; T01, T02, T28 and T30 are PARTIAL with named gaps. Promotion to PASS requires `APPLICATION_ACCEPTANCE` / `FULL_SCENARIO` records, which the two human rehearsals are designed to produce. Per-scenario detail: `handoffs/work/final-prototype-continuation/T01-T30-reconciliation.md`. T31–T34 remain unpromoted. |
