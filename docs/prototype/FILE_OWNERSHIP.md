...
| `packages/contracts/**`, `packages/domain/**`, `packages/privacy-control/**`, `packages/db/**`, `packages/auth/**`, `packages/authz/**`, `packages/connectors/**`, `packages/policy-sdk/**`, `packages/testing/**` | Codex | Includes generated contracts/client transport; no frontend-only copy. `packages/privacy-control/**` is the bounded policy/send-admission module (2026-09-19 extraction from `packages/domain/src/processing/`); it depends on `@orvia/domain`'s shared primitives only, never on a specific connector |
| `apps/web/src/app/api/**`, `packages/backend/**`, auth middleware/server entry points | Codex | Backend request-handler logic (business/machine/session/admin-principals/auth routing) moved out of `apps/web/src/server/` (removed 2026-09-19) into `packages/backend/**`; `apps/web/src/app/api/**` route files stay thin adapters over `@orvia/backend`. UI imports permitted client interfaces only; no secrets bundled client-side |
