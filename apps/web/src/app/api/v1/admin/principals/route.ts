...
import { PrincipalCreate, Principal, Pagination, Id, schemas } from '../../../../../../../../packages/contracts/src/index.ts';
...
export const POST = (request: Request) => safeRoute(async requestId => {
  const r = runtime(); const actor = await authorityFor(request, r.staff, r.principal);
