...
export function buildId(){try{return readFileSync(resolve(process.env.ORVIA_WORKSPACE_ROOT??process.cwd(),'frontend/.next/BUILD_ID'),'utf8').trim();}catch{return 'development-unqualified';}}
