import { routes, schemas, Pagination, Id, PolicyReauthenticate, type RouteDefinition } from '../../contracts/src/index.ts';
...
import { configurationList, createConfiguration, createMapping, mappingList, controlMap, publishPolicy, recordPublicationProof, publicationCandidate, type ConfigurationKind } from '../../domain/src/configuration/configuration.ts';
