...
export const roleCapabilities: Record<string, string[]> = {
  ORG_SUPER_ADMIN: [...read, 'configuration.write', 'policy.publish', 'systems.check', 'principals.create', 'action.reconcile', 'manual.attest', 'policy.preview', 'tests.run', 'graph.write', 'rights.write', 'rights.release', 'retention.write', 'retention.approve', 'coverage.manage', 'processor.write', 'incident.write', 'incident.approve', 'notification.manage', 'licence.manage', 'support.manage', 'support.approve', 'update.approve', 'audit.administer', 'audit.export', 'connection.enable'],
